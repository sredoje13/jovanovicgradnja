import { Datas } from "../models/firstpagedatas";
...
export const firstdivs = [
  ...
  new Datas(
    ...
    "Izvršili smo značajna ulaganja u mehanizaciju i opremu kako bismo unapredili kvalitet svakog projekta. Jovanović gradnja poklanja veliku pažnju bezbednosti pri realizaciji projekata, kao građevinskih poslova tako i radnika"
  ),
];
